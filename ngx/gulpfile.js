...
var ngxFiles = {
  ...
  filesToCopy: [
    ...
    {
      src: [
        path.join(bowerDirectory, '/angular-aria/angular-aria.js'),
        path.join(bowerDirectory, '/angular-aria/angular-aria.min.js'),
        path.join(bowerDirectory, '/angular-aria/angular-aria.min.js.map')
      ],
      dest: path.join(outputDirectory, '/vendor/angular-aria/')
    },
    {
      src: [
    ...
    {
      src: [
        path.join(bowerDirectory, '/angular-material/angular-material.js'),
        path.join(bowerDirectory, '/angular-material/angular-material.min.js'),
        path.join(bowerDirectory, '/angular-material/angular-material.css'),
        path.join(bowerDirectory, '/angular-material/angular-material.min.css')
      ],
      dest: path.join(outputDirectory, '/vendor/angular-material/')
    }
  ],
